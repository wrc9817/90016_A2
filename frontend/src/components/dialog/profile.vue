    ...
    <div>
      <div class="title">
        <el-upload
          class="upload-demo"
          :limit="1"
          action="http://localhost:8099/users/avatar"
          name="avatar"
          methods="post"
          :data="{
            userId:userInfo.id
          }"
          :on-success="handleRecieve"
        >
          <el-avatar class="clickable" :size="'large'" :src="userInfo.avatar?userInfo.avatar:'https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png'" />
        </el-upload>
